...
const EditBlogClient = ({ isCreate }: EditBlogClientProps) => {
  ...
  const { mutateAsync: createBlogAsync, isPending: isCreating } =
    useCreateBlogMutation();
  const { mutateAsync: updateBlogAsync, isPending: isUpdating } =
    useUpdateBlogMutation();
  const { mutateAsync: analyzeTitleAsync, isPending: isAnalyzingTitle } =
    useAnalyzeTitleMutation();
  const {
    mutateAsync: analyzeDescriptionAsync,
    isPending: isAnalyzingDescription,
  } = useAnalyzeDescriptionMutation();
  const { mutateAsync: analyzeContentAsync, isPending: isAnalyzingContent } =
    useAnalyzeContentMutation();
                      ...
                      <div className="space-y-2">
                        ...
                        {formData.description === "" ? null : (
                          ...
                          >
                            <RefreshCw
                              className={
                                isAnalyzingDescription ? "animate-spin" : ""
                              }
                              size={16}
                            />
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {formData.content === "" ? null : (
                        ...
                        >
                          <RefreshCw
                            size={16}
                            className={isAnalyzingContent ? "animate-spin" : ""}
                          />
